...
export const TerraformIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M3.63 21.429h5.143V10.286L3.63 7.157v14.272zM9.3 0v6.857l5.143 3.143V3.143L9.3 0zm5.671 13.443-5.143-3.143v10.557l5.143 3.143V13.443zM15.5 3.429v6.857l5.143-3.143V.286L15.5 3.429z"></path>
    </svg>
);
